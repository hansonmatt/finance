...
class TransactionRowProcessor:
    ...
    def transactionDictionaryFromRow(self, theRow):
...
class BrokerageTransactionRowProcessor(TransactionRowProcessor):
...
class SMATransactionRowProcessor(TransactionRowProcessor):
